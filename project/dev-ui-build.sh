...
targetbase="$wdir/modules/webapp/target/scala-2.13/classes/META-INF/resources/webjars/sharry-webapp/$version"
resourcebase="$wdir/modules/webapp/target/scala-2.13/resource_managed/main/META-INF/resources/webjars/sharry-webapp/$version"
...
compile_js() {
    ...
    elm make --debug --output "$targetbase/sharry-app.js" "$srcs"
    cat "$targetbase/sharry-app.js" | gzip > "$targetbase/sharry-app.js.gz"
    cp "$targetbase/sharry-app.js" "$resourcebase/"
    cp "$targetbase/sharry-app.js.gz" "$resourcebase/"
}
