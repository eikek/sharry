...
-- onKeyDown expectedCode msg =
--     let
--         isCode code =
--             if code == expectedCode then
--                 Json.succeed msg
--             else
--                 Debug.log("not expected key " ++ (toString expectedCode) ++ " vs " ++ (toString code))
--                 Json.fail "not expected key"
--     in
--         on "keydown" (Json.andThen isCode keyCode)
...
-- moveResults: Model -> Int -> Msg
-- moveResults model code =
--     if code == 38 then SetActiveResult (findPrevActive model)
--     else if code == 40 then SetActiveResult (findNextActive model)
--     else SetActiveResult (findNextActive model)
...
--         [] -> List.head list
--         h :: t ->
--             if h == a then (List.head t)
--             else findNext t a

-- findPrev: List a -> a -> Maybe a
-- findPrev list a =
--     findNext (List.reverse list) a
